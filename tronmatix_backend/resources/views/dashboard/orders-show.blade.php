...
@section('content')
    ...
    @if(!$_permDenied)
            ...
            <div style="display:flex; flex-direction:column; gap:20px; min-width:0;">
                    ...
                    <div class="card-body">
                        <div class="order-info-grid"
                            ...
                            @foreach([
                                ...
                                <div>
                                    <div
                                        style="font-size: var(--title-size); letter-spacing:2px; color:rgba(255,255,255,0.3); margin-bottom:5px;">
                                        {{ strtoupper($label) }}
                                    </div>
                                    <div
                                        style="font-weight:700; color:{{ $label === 'Payment Status' && $value === 'PAID' ? '#22c55e' : '#fff' }};">
                                        {{ $value }}
                                    </div>
                                </div>
                            @endforeach
                            ...
                            @if($order->delivery_confirmed_at)
                                <div>
                                    ...
                                    <div style="font-weight:700; color:#22c55e;">
                                        ✅ {{ $order->delivery_confirmed_at->setTimezone('Asia/Phnom_Penh')->format('d M Y, H:i') }}
                                        (ICT)
                                    </div>
                                </div>
                            @endif
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        @php
                            ...
                            if ($current === false)
                                $current = ($order->status === 'cancelled') ? -1 : 0;
                        @endphp
                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th>UNIT PRICE</th>
                                    @if($hasDiscount)
                                    <th style="color:#4ade80;">AFTER DISCOUNT</th> @endif
                                    <th>QTY</th>
                                    <th>TOTAL</th>
                                </tr>
                            </thead>
                                ...
                                @foreach($order->items as $item)
                                    ...
                                    <tr>
                                            ...
                                            <div style="display:flex; align-items:center; gap:12px;">
                                                ...
                                                @if($thumbSrc)
                                                    ...
                                                    <div class="product-thumb"
                                                        style="display:none; align-items:center; justify-content:center; font-size: var(--title-size);">
                                                        📦</div>
                                                @else
                                                    <div class="product-thumb"
                                                        style="display:flex; align-items:center; justify-content:center; font-size: var(--title-size);">
                                                        📦</div>
                                                @endif
                                                <div>
                                        ...
                                        <td>
                                            @if($hasDiscount)
                                                <span
                                                    style="text-decoration:line-through; color:rgba(255,255,255,0.35); font-size: var(--title-size);">
                                        ...
                                        <td style="color:#F97316; font-weight:700;">
                                            ...
                                            @if($hasDiscount)
                                                <div
                                                    style="font-size: var(--title-size); text-decoration:line-through; color:rgba(255,255,255,0.25);">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {{-- Address info row --}}
                        <div
                            style="display:grid; grid-template-columns:repeat(auto-fit,minmax(180px,1fr)); gap:16px; margin-bottom:{{ $mapLat && $mapLng ? '20px' : '0' }};">
                            <div style="display:flex; align-items:flex-start; gap:10px;">
                                <span style="font-size: var(--title-size);">👤</span>
                                <div>
                                    <div
                                        style="font-size: var(--title-size); letter-spacing:2px; color:rgba(255,255,255,0.3); margin-bottom:2px;">
                                        NAME</div>
                            ...
                            <div style="display:flex; align-items:flex-start; gap:10px;">
                                ...
                                <div>
                                    <div
                                        style="font-size: var(--title-size); letter-spacing:2px; color:rgba(255,255,255,0.3); margin-bottom:2px;">
                                        PHONE</div>
                                    <div style="font-weight:700; color:#F97316; font-size: var(--title-size);">{{ $phone }}
                                    </div>
                                </div>
                            </div>
                            <div style="display:flex; align-items:flex-start; gap:10px;">
                                ...
                                <div style="display:flex; align-items:flex-start; gap:10px;">
                                    ...
                                    <div>
                                        <div
                                            ...
                                            NOTE</div>
                                        <div
                                            style="color:rgba(255,255,255,0.5); font-size: var(--title-size); font-style:italic; word-break: break-word;">
                                            {{ $note }}</div>
                                    </div>
                                </div>
                            @endif
                        ...
                        @if($mapLat && $mapLng)
                            <div>
                                <div
                                    style="font-size: var(--title-size); letter-spacing:2px; color:rgba(255,255,255,0.3); font-weight:700; margin-bottom:8px; display:flex; align-items:center; gap:8px;">
                                    📍 PINNED DELIVERY ROUTE
                                </div>
                                <div id="order-map"
                                    style="height:400px; border-radius:12px; overflow:hidden; border:1px solid rgba(255,255,255,0.08);">
                                </div>
                                <div
                                    style="display:flex; align-items:center; justify-content:space-between; margin-top:8px; flex-wrap:wrap; gap:8px;">
                                    @if($mapAddr)
                            ...
                            <div class="status-btn-grid" style="display:grid; grid-template-columns:1fr 1fr; gap:8px;">
                                @foreach($statusMeta as $key => $meta)
                                    ...
                                    <button onclick="openStatusPopup('{{ $key }}')" @if($isCurrentStatus) disabled @endif style="
                                        ...
                                        font-size: var(--text-md); font-weight:700; letter-spacing:1px;
                    ...
                    <div class="card-body">
                        <div style="display:flex; flex-direction:column; gap:12px;">
                            ...
                            <div style="display:flex; justify-content:space-between; font-size: var(--title-size);">
                                ...
                                <span
                                    style="word-break: break-all; text-align: right;">${{ number_format($order->subtotal ?? $order->total, 2) }}</span>
                            </div>
                            ...
                            @if($order->discount_amount > 0)
                                <div style="display:flex; justify-content:space-between; font-size: var(--title-size);">
                                    ...
                                    <span
                                        style="color:#22c55e; font-weight:700; flex-shrink: 0;">−${{ number_format($order->discount_amount, 2) }}</span>
                                </div>
                            @endif
                            ...
                            @if($order->delivery > 0)
                                <div style="display:flex; justify-content:space-between; font-size: var(--title-size);">
                                    ...
                                    <span
                                        style="word-break: break-all; text-align: right;">${{ number_format($order->delivery, 2) }}</span>
                                </div>
                            @endif
                            ...
                            @if($order->tax > 0)
                                <div style="display:flex; justify-content:space-between; font-size: var(--title-size);">
                                    ...
                                    <span
                                        style="word-break: break-all; text-align: right;">${{ number_format($order->tax, 2) }}</span>
                                </div>
                            @endif
                        ...
                        <div class="card-body">
                            <div style="display:flex; flex-direction:column; gap:12px;">
                                ...
                                @if($order->province?->deliveryZone)
                                    <div>
                                        <div
                                            style="font-size: var(--title-size); letter-spacing:2px; color:var(--text-faint); margin-bottom:2px;">
                                            ZONE</div>
                                        <span class="badge"
                                            style="
                                    ...
                                    <div style="display:flex; align-items:flex-start; gap:10px;">
                                        ...
                                        <div>
                                            <div
                                                style="font-size: var(--title-size); letter-spacing:2px; color:var(--text-faint); margin-bottom:2px;">
                                                PROVIDER</div>
                                            <div style="font-weight:700; color:#F97316; font-size: var(--title-size);">
                                                {{ $order->deliveryProvider->name }}</div>
                                        </div>
                                    </div>
                                @endif
                                    ...
                                    <div style="display:flex; align-items:flex-start; gap:10px;">
                                        ...
                                        <div>
                                            ...
                                            <div style="font-weight:700; color:#fff; font-size: var(--title-size);">
                                                ${{ number_format($order->deliveryProvider->fee, 2) }}</div>
                                        </div>
                                    </div>
                                @endif
                                    ...
                                    <div style="display:flex; align-items:flex-start; gap:10px;">
                                        ...
                                        <div>
                                            <div
                                                ...
                                                ESTIMATED TIME</div>
                                            <div style="font-weight:600; color:#fff; font-size: var(--title-size);">
                                                {{ $order->deliveryProvider->estimated_time }}</div>
                                        </div>
                                    </div>
                                @endif
                            ...
                            <div style="display:flex; align-items:flex-start; gap:10px;">
                                ...
                                <div>
                                    <div
                                        ...
                                        {{ $label }}</div>
                                    <div
                                        style="font-weight:700; color:{{ $color }}; font-size: var(--title-size); line-height:1.5; white-space:pre-line;">
                                        {{ $val }}</div>
                                </div>
                            </div>
                            @endforeach
        ...
        @if($nextAction)
            <div id="popup-confirm-delivery" class="popup-overlay" onclick="if(event.target===this) closePopup('confirm-delivery')">
                <div class="popup-box" id="popup-confirm-delivery-box">
                    ...
                    @endphp
                    <div
                        style="background:{{ $nextAction['color'] }}11; border:1px solid {{ $nextAction['color'] }}33; border-radius:12px; padding:14px 16px; margin-bottom:20px;">
                        <div
                            style="font-size: var(--title-size); color:rgba(255,255,255,0.35); letter-spacing:2px; font-weight:700; margin-bottom:10px;">
                            FLOW</div>
                        <div style="display:flex; align-items:center; gap:6px; flex-wrap:wrap;">
                            @foreach($popupSteps as $sKey => $sData)
                                ...
                                <div style="display:flex; align-items:center; gap:4px;">
                                    ...
                                    @if(!$loop->last)<span
                                    style="color:rgba(255,255,255,0.2);font-size: var(--title-size);">›</span>@endif
                                </div>
                            @endforeach
                        </div>
                    </div>
        ...
        @foreach($statusMeta2 as $key => $meta)
            @if($order->status !== $key)
                <div id="popup-status-{{ $key }}" class="popup-overlay"
                    onclick="if(event.target===this) closeStatusPopup('{{ $key }}')">
                    <div class="popup-box" id="popup-status-{{ $key }}-box">
                        ...
                        <div
                            style="background:rgba(255,255,255,0.04); border:1px solid rgba(255,255,255,0.08); border-radius:12px; padding:14px 16px; margin-bottom:20px;">
                            <div style="display:flex; justify-content:space-between; font-size: var(--title-size); margin-bottom:8px;">
                                ...
                                <span class="badge badge-{{ $order->status }}"
                                    style="font-size: var(--title-size);">{{ strtoupper($order->status) }}</span>
                            </div>
                            <div style="display:flex; justify-content:space-between; font-size: var(--title-size);">
                                <span style="color:rgba(255,255,255,0.4);">New status</span>
                                <span
                                    style="font-weight:800; color:{{ $meta['color'] }}; font-size: var(--title-size);">{{ $meta['icon'] }}
                                    {{ $meta['label'] }}</span>
                            </div>
                            <div
                                style="margin-top:10px; font-size: var(--title-size); color:rgba(255,255,255,0.4); border-top:1px solid rgba(255,255,255,0.07); padding-top:10px;">
                                {{ $meta['msg'] }}
                            </div>
                        </div>
                        ...
                        @if($key === 'cancelled')
                            <div
                                ...
                                <span>⚠️</span> <span>Cancellation cannot be undone. Product stock will be fully restored. Order amount stays in records for accounting.</span>
                            </div>
                        @endif
        ...
        <div id="thermal-receipt">
            ...
            <div class="tr-row">
                <span>Date</span><span>{{ $order->created_at->setTimezone('+07:00')->format('d M Y H:i') }}</span></div>
            ...
            @if($rHasDiscount)
                <div class="tr-row"><span>Subtotal</span><span>${{ number_format($order->subtotal ?? $order->total, 2) }}</span>
                </div>
                <div class="tr-row">
                    <span>Discount{{ $order->discount_code ? ' (' . $order->discount_code . ')' : '' }}</span><span>−${{ number_format($order->discount_amount, 2) }}</span>
                </div>
            @endif
            @php
            ...
            <div style="font-size: var(--title-size); margin-bottom:2px;">📍 {{ $rAddress }}{{ $rCity ? ', ' . $rCity : '' }}
            </div>
            @if($rNote)
            <div style="font-size: var(--title-size); color:#555; font-style:italic;">Note: {{ $rNote }}</div>@endif

            <div class="tr-divider"></div>
            <div class="tr-center tr-bold" style="font-size: var(--title-size);">Thank you for your order!</div>
            <div class="tr-center" style="font-size: var(--title-size); margin-top:2px; color:#555;">Status:
        ...
        <script>
            (function () {
                function initOrderMap() {
                    ...
                    // OSRM GeoJSON — coordinates arrive as [lng,lat], Leaflet needs [lat,lng]
                    const osrmUrl = `https://router.project-osrm.org/route/v1/driving/${STORE_LNG},${STORE_LAT};${USER_LNG},${USER_LAT}?overview=full&geometries=geojson`;
