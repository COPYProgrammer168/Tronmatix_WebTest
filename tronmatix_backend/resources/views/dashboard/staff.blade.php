...
@php
    ...
    $adminRoleMeta = [
        'superadmin' => [
            ...
            'color' => '#F97316',
            'icon' => '👑',
            'desc' => 'Full system owner access',
        ],
        'admin' => [
            'label' => 'Admin',
            'color' => '#fb923c',
            'icon' => '🛡️',
            'desc' => 'Full access, manage staff & settings',
        ],
    ];
    ...
    $staffRoleMeta = [
        'editor' => [
            ...
            'color' => '#3b82f6',
            'icon' => '✏️',
            'desc' => 'Products, banners, discounts',
        ],
        'seller' => [
            'label' => 'Seller',
            'color' => '#10b981',
            'icon' => '🏪',
            'desc' => 'Products, orders & discounts management',
        ],
        'delivery' => [
            'label' => 'Delivery',
            'color' => '#a855f7',
            'icon' => '🚚',
            'desc' => 'Handles order deliveries',
        ],
        'developer' => [
            'label' => 'Developer',
            'color' => '#06b6d4',
            'icon' => '💻',
            'desc' => 'Technical & system development',
        ],
    ];
