...
<div style="max-width:800px; margin:0 auto; padding:24px;">
    <div style="margin-bottom:24px;">
        ...
        <h1 style="font-size:var(--text-2xl); font-weight:800; letter-spacing:2px; color:var(--text); margin:12px 0 4px;">ADD SUB CATEGORY</h1>
        <p style="font-size:var(--text-sm); color:var(--text-muted);">Level 3 of the navigation tree (Category → MainCate → SubCate → Brand)</p>
    </div>
        ...
        <form method="POST" action="{{ route('dashboard.sub-categories.store') }}">
            ...
            <div style="display:flex; flex-direction:column; gap:20px;">
                <div>
                    ...
                    <div style="font-size:12px; color:var(--text-xfaint); margin-top:4px;">Only active main categories are shown.</div>
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required class="s-input" style="margin-top:6px;" placeholder="e.g. UNDER 1K">
