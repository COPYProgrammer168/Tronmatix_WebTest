...
<head>
    ...
    <title>Create Admin — Tronmatix</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-logo .brand-name { font-size: 20px; font-weight: 700; letter-spacing: 4px; color: #fff; }
        .auth-logo .brand-sub  { font-size: 9px; letter-spacing: 5px; color: var(--orange); margin-top: 2px; }
...
<div class="auth-card">
    ...
    <div class="auth-body">
        ...
        <div class="auth-logo">
            ...
            <div class="admin-badge">CREATE FIRST ADMIN</div>
        </div>
        ...
        <div class="alert alert-info" style="font-size:12px;">
            ...
            This account will be created as <strong>Superadmin</strong>.
            Registration is only available once — when no admins exist.
        </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    <input type="email" name="email" class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}"
                           value="{{ old('email') }}" placeholder="admin@tronmatix.com" />
                </div>
