...
<head>
    ...
    <title>Verify Code — Tronmatix</title>
...
<div class="auth-card">
    ...
    <div class="auth-body">
        ...
        <div class="auth-logo">
            ...
            <div class="badge">
                🔐 {{ $mode === 'staff' ? 'STAFF' : 'ADMIN' }} — ENTER CODE &amp; NEW PASSWORD
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('dashboard.password.phone.verify.post') }}" id="verifyForm">
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    <input type="tel" name="phone" class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}"
                           value="{{ $phone ?? old('phone') }}" required readonly />
                </div>
            ...
            <div class="form-group">
                ...
                @error('otp')<div style="color:#EF4444;font-size:11px;margin-top:4px;">{{ $message }}</div>@enderror
            </div>
        ...
        <div class="auth-footer" style="margin-top:22px;">
            Didn't get a code?
            <a href="{{ route('dashboard.password.phone', ['mode' => $mode]) }}">Request again</a>
        </div>
