 ...
 * @route '/livewire-fcee48b0/upload-file'
 */
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-fcee48b0/upload-file',
 ...
 * @route '/livewire-fcee48b0/preview-file/{filename}'
 */
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-fcee48b0/preview-file/{filename}',
