 ...
 * @see app/Http/Controllers/Dashboard/CategoryController.php:14
 ...
 * @see app/Http/Controllers/Dashboard/CategoryController.php:40
...
/**
* @see \App\Http\Controllers\Dashboard\CategoryController::toggle
 * @see app/Http/Controllers/Dashboard/CategoryController.php:53
 * @route '/dashboard/categories/{category}/toggle'
 */
...
toggle.definition = {
    methods: ["patch"],
    url: '/dashboard/categories/{category}/toggle',
 ...
 * @see app/Http/Controllers/Dashboard/CategoryController.php:60
 * @route '/dashboard/categories/{category}'
 */
