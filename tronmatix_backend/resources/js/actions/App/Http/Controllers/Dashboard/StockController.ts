...
/**
* @see \App\Http\Controllers\Dashboard\StockController::resetRandom
 * @see app/Http/Controllers/Dashboard/StockController.php:97
 * @route '/dashboard/stock/reset'
 */
export const resetRandom = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: resetRandom.url(options),
    method: 'post',
})

resetRandom.definition = {
    methods: ["post"],
 ...
 * @route '/dashboard/stock/reset'
 */
resetRandom.url = (options?: RouteQueryOptions) => {
    return resetRandom.definition.url + queryParams(options)
}
 ...
 * @route '/dashboard/stock/reset'
 */
resetRandom.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: resetRandom.url(options),
    method: 'post',
})
 ...
 * @route '/dashboard/stock/reset'
 */
    const resetRandomForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: resetRandom.url(options),
        method: 'post',
    })
 ...
 * @route '/dashboard/stock/reset'
 */
        resetRandomForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: resetRandom.url(options),
            method: 'post',
        })
    
    resetRandom.form = resetRandomForm
/**
...
const StockController = { index, receive, adjust, damaged, resetRandom, history, report, exportMethod, export: exportMethod }
