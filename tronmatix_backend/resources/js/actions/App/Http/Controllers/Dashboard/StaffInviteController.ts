 ...
 * @see app/Http/Controllers/Dashboard/StaffInviteController.php:18
 ...
 * @see app/Http/Controllers/Dashboard/StaffInviteController.php:32
 * @route '/dashboard/invite/{token}'
 */
...
const StaffInviteController = { show, accept }

export default StaffInviteController