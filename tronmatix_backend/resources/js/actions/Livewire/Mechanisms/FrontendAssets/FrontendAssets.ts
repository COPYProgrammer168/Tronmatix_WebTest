 ...
 * @route '/livewire-fcee48b0/livewire.js'
 */
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-fcee48b0/livewire.js',
 ...
 * @route '/livewire-fcee48b0/livewire.min.js.map'
 */
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-fcee48b0/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/livewire-fcee48b0/livewire.csp.min.js.map'
 */
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-fcee48b0/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
