...
export default function HomePage() {
  ...
  .banner-wrap {
    aspect-ratio: 16 / 6;        /* laptop/desktop — shorter */
  }
  @media (max-width: 1280px) {
    .banner-wrap { aspect-ratio: 16 / 7; max-height: 420px; }  /* medium laptop */
  }
  @media (max-width: 1024px) {
    .banner-wrap { aspect-ratio: 16 / 8; max-height: 360px; }  /* tablet */
  }
        ...
        return (
          <div className="my-12 mx-4 lg:mx-auto max-w-5xl rounded-3xl overflow-hidden relative"
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between p-8 md:p-12 gap-6 text-white">
              ...
              <a href="https://t.me/+VZScFi_U95PsFk0M" target="_blank" rel="noopener noreferrer"
