...
// FeedbackForm moved to Footer component
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        <div
          className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 text-primary"
    ...
    <div style={{ minHeight: "100vh", background: bg, fontFamily: bodyFont }}>
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to right, transparent, #F97316 30%, #F97316 70%, transparent)",
          }}
        />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <div className="relative flex items-center justify-center mb-4">
                ...
                <div
                  ...
                  style={{
                    ...
                    boxShadow:
                      "0 8px 40px rgba(249,115,22,0.20), inset 0 0 30px rgba(249,115,22,0.05)",
                  }}
                >
                  <img
                    src={logo}
                    ...
                    style={{
                      ...
                      height: 130,
                      objectFit: "contain",
                      filter: "drop-shadow(0 0 16px rgba(249,115,22,0.50))",
                    }}
                  />
                </div>
              </div>
              ...
              <div className="text-center leading-snug">
                ...
                <div
                  className="font-bold"
                  style={{ fontSize: 20, color: "#F97316", letterSpacing: 4 }}
                >
                  COMPUTER
                </div>
              </div>
            ...
            <div className="flex flex-col items-center text-center px-2">
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <span
                  className="font-black"
                  style={{ fontSize: 18, color: "#F97316", letterSpacing: 1 }}
                >
                  {t("contact.Welcome")}
                </span>
              ...
              <h1
                ...
                style={{
                  ...
                  textShadow: dark
                    ...
                    : "0 2px 20px rgba(249,115,22,0.10)",
                }}
              >
                {t("contact.title")}
              </h1>
              ...
              {[
                {
                  ...
                  content: (
                    ...
                    >
                      {t("contact.address")}
                      <span
                        className="block mt-1 font-bold text-primary"
                        style={{ fontSize: 13 }}
                      >
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              >
                ...
                >
                  {t("contact.address")}
                  <span
                    className="block mt-1.5 font-bold text-primary"
                    style={{ fontSize: 13 }}
                  >
                    📍 {t("contact.viewOnMaps")} →
                  </span>
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div
                  className="ml-auto flex items-center gap-1.5 px-3 py-1 rounded-full font-black flex-shrink-0"
                  style={{
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  },
                  {
                    icon: "🛡️",
                    label: "Warranty",
                    value: "1–3 Years Official",
                  },
                  {
                    icon: "💻",
                    label: "Products",
                    value: "PCs, Laptops, Monitors",
                  },
