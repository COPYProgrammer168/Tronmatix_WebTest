  ...
  if (!product)
    return (
      ...
      >
        ...
        <p style={{ fontSize: 18, color: dark ? "#f9fafb" : "#1f2937" }}>
          Product not found.
        </p>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span>›</span>
        <span className="font-semibold" style={{ color: textCol }}>
          {product.name}
        </span>
      </div>
        ...
        <div className="flex-1 flex flex-col">
          ...
          <h1
            ...
            style={{
              ...
              color: "#F97316",
              lineHeight: isKhmer ? 1.7 : undefined,
          ...
          <div className="mb-4">
            ...
            {productDiscounted &&
              itemDiscounts.map((d, idx) => (
                <div
                  key={idx}
                  className="mt-3 flex items-center gap-3 rounded-xl px-4 py-3 flex-wrap"
                  style={{
                    background:
                      d.source === "public"
            ...
            {discount && !productDiscounted && (
              ...
              >
                <span
                  style={{ fontSize: 12, color: dark ? "#6b7280" : "#9ca3af" }}
                >
                  Code <strong>{discount.code}</strong> doesn't apply to this
                  category
                </span>
              </div>
            )}
          ...
          <div className="flex items-center gap-3 flex-wrap mt-auto">
            ...
            {isAskPrice ? (
              ...
              <>
                ...
                {/* Ask More — opens owner Telegram (always visible for in-stock products) */}
                <a href={telegramLink} target="_blank" rel="noopener noreferrer"
                  className="flex-shrink-0 font-bold py-3 px-5 rounded-lg transition-all text-white flex items-center justify-center gap-2 hover:scale-[1.02]"
                  ...
                  <span>{isKhmer ? 'សាកសួរព័ត៏មាន' : 'ASK MORE'}</span>
                </a>
              </>
            )}
          </div>
          ...
          {productDiscounted && qty > 1 && (
            <div
              className="mt-3 p-3 rounded-xl flex justify-between items-center"
              style={{
            ...
            >
              <span
                className="font-semibold"
                style={{ fontSize: 14, color: dark ? "#86efac" : "#15803d" }}
              >
      ...
      {related.length > 0 && (
        <div>
          <div className="flex items-center gap-4 mb-4">
            ...
            >
              {isKhmer
                ? `${t("product.relatedProducts")}${product.category ? ` - ${product.category}` : ""}`
          ...
          <div
            className="related-scroll flex md:grid md:grid-cols-5 gap-4 overflow-x-auto md:overflow-x-visible pb-3 md:pb-0"
            style={{
              scrollbarWidth: "thin",
          ...
          `}</style>
            {related.slice(0, 5).map((r, i) => (
              <div
                key={r.id || i}
                className="flex-shrink-0 md:flex-shrink w-[160px] sm:w-[180px] md:w-auto"
              >
