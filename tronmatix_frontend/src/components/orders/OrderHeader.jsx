    ...
    <div className="flex items-center justify-between mb-6">
      <div>
        <h1
          ...
          style={{ fontFamily: khfont, fontSize: isKhmer ? 30 : 35, letterSpacing: isKhmer ? 1 : 1.5, color: dark ? "#f9fafb" : "#111827" }}
        >
          {isKhmer ? 'ការបញ្ជាទិញរបស់អ្នក' : 'MY ORDERS'}
        </h1>
        <p style={{ fontFamily: bodyFont, fontSize: 20, color: dark ? "#9ca3af" : "#374151" }}>
      ...
      <Link
        ...
        style={{ fontFamily: bodyFont, fontSize: 20 }}
      >
